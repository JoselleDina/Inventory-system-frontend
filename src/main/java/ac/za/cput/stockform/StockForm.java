...
import ac.za.cput.universityform.UniversityForm;
...
public class StockForm extends javax.swing.JFrame {
    ...
    */
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        UniversityForm uni = new UniversityForm();
        uni.setVisible(true);
    ...
    public void populateTable() {
        ...
        try {
            ...
            DefaultTableModel model = new DefaultTableModel(new String[]{"Stock ID", "Date", "Device ID","Furniture ID","Quantity"}, 0);
            ...
            while(rs.next())
            {
                ...
                String fId = rs.getString("furniture_id");
                int quantity = rs.getInt("quantity");
                model.addRow(new Object[]{id,date,dId,fId,quantity});
            }
